...
# Some resources for tuning: http://blog.sokolenko.me/2014/11/javavm-options-production.html
...
CATALINA_OPTS="$CATALINA_OPTS -Dmail.mime.decodeparameters=true -Djava.awt.headless=true"
